...
const Hero = () => {
  ...
  useGSAP(
    () => {
      ...
      let scrambleIntervalHandle: ReturnType<typeof setInterval> | null = null;
      const ctx = gsap.context(() => {
        ...
        const scrambleAnimation = () => {
          ...
          const word = PLACE_WORDS[wordIndex];
          if (!word) return;
        ...
        let drapeTl: gsap.core.Timeline | null = null;
        ...
        <div className={styles.container}>
          <div className={styles.heroContent}>
            ...
            <div ref={taglineRef} className={styles.tagline}>
              ...
              <p
                ref={scrambleRef}
                id='hero-scramble-text'
                className={styles.scrambleText ? styles.scrambleText : ''}
              >
                connections
              </p>
            </div>
