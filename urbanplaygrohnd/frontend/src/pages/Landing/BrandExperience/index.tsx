...
const BrandExperience = () => {
  ...
  useGSAP(
    () => {
      ...
      const transitionTl: gsap.core.Timeline = gsap.timeline({ paused: true });
      ...
      <div className={styles.container}>
        ...
        <div className={styles.showcaseWrapper}>
          <AnimatePresence mode='wait'>
            {!showEventView ?
              <DashboardView key='dashboard' ref={dashboardRef} isTransitioning={isTransitioning} />
            : <EventView key='event' ref={eventRef} isTransitioning={isTransitioning} />}
          </AnimatePresence>
        </div>
        ...
        <div className={styles.comingSoonNote}>
          <div className={styles.noteContent}>
            <div className={styles.noteText}>
              ...
              <p>
                Full event theming with custom colors, fonts, and branding elements coming in our
                next major update. Make every event truly yours while keeping uplayground beautifully
                minimal.
              </p>
            </div>
          </div>
