...
export const DashboardView = forwardRef<HTMLDivElement, DashboardViewProps>(
  ({ isTransitioning }, ref) => {
    return (
      <motion.div
        ref={ref}
      ...
      >
        {/* uplayground Dashboard Mock - Matches real TopNav */}
        <div className={styles.dashboardHeader}>
          {/* Left: uplayground text logo */}
          <div className={styles.navLeft}>
            <div className={styles.atriaTextLogo}>uplayground</div>
          </div>
