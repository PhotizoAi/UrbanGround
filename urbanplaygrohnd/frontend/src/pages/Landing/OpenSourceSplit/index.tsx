...
const panels: Panel[] = [
  {
    ...
    description:
      'Whether you value complete control or managed convenience, uplayground adapts to your needs',
    gradient: 'radial',
  },
  {
    id: 'opensource',
    ...
    description:
      'We believe great software should be accessible to everyone. Join hundreds of communities using uplayground to create meaningful connections.',
  ...
  },
  {
    ...
    description:
      'Get the full power of uplayground with enterprise-grade support, custom integrations, and managed hosting options.',
    cta: 'Talk to Sales',
    ctaIcon: 'calendar',
  },
  {
    ...
    content:
      "No vendor lock-in. No hidden algorithms. No surprises. uplayground is built by event organizers, for event organizers. Every line of code is yours to inspect, modify, and improve. Your feedback directly shapes our roadmap because transparency isn't just a feature, it's our foundation.",
    footer:
