...
/**
 * Pre-render script using Playwright (Netlify-compatible version)
 *
 * This script:
 * 1. Launches a headless browser
 * 2. Visits the built landing page (detects localhost vs Netlify URL)
...
// Detect the preview URL - use Netlify URL if available, otherwise localhost
...
${criticalCSS}    </style>
    ...
    if (html.includes('uplayground') || html.includes('community')) {
